...
from hunter.commands.complete_template import CompleteTemplate
from hunter.commands.config import red_text, green_text, blue_text, yellow_text, reset_all
from hunter.commands.tools import re_name
