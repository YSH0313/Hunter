...
from hunter.core import ManagerRabbitmq
...
class RabbitmqSpider(ManagerRabbitmq):
    ...
    async def execute(self):
        ...
        # 开启消费者
        # await asyncio.create_task(self.consumer_rabbitmq())
        consumer_task = asyncio.create_task(self.consumer_rabbitmq())
